 ...
 **Henry Huỳnh** - [Facebook Profile](https://www.facebook.com/henryhuynh2)
 ...
 - **AI Voice Consistency (Mới)**: Đảm bảo kịch bản không bị "lạc giọng" bằng cách đồng nhất **Giọng đọc** (Voice) và **Tông giọng** (Style) cho toàn bộ các phần.
 - **Tông giọng đa dạng**: Hỗ trợ 5 phong cách đọc khác nhau (Bình thản, Cảm xúc, Năng lượng, Quyền lực, Vui vẻ).
 - **Ghép nối âm thanh**: Tự động ghép nối các phần Voice thành một file MP3 hoàn chỉnh.
 - **Thumbnail Art Director Pro**: Cho phép chọn lựa Model (Flash/Pro), Kích thước (1K/2K/4K) và Tỷ lệ khung hình ngay tại bước tạo Thumbnail kèm chữ.
 - **Tải xuống thông minh**: Tên tệp Thumbnail và MP3 được tự động đặt theo nội dung chữ hoặc chủ đề (không dấu).
